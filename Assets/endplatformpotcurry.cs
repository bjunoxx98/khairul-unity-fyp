...
//FOR ALGO STAGE - LAMB CURRY
public class endplatformpotcurry : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        //----------------------------------------------------------------------------
        else if (collision.gameObject.name == "spices(Clone)") //4TH INGREDIENT
        {
            //check if previous step completed first
            if (step3done == true)
            {
                ...
                Debug.Log(collision.gameObject.name); Debug.Log("THIS IS spices");
                collision.gameObject.SetActive(false);
                textwrong.SetActive(false);
        ...
        //----------------------------------------------------------------------------
        else if (collision.gameObject.name == "daunkari(Clone)") //5TH INGREDIENT
        {
            //check if previous step completed first
            if (step4done == true)
            {
                ...
                Debug.Log(collision.gameObject.name); Debug.Log("THIS IS daunkari");
                collision.gameObject.SetActive(false);
                textwrong.SetActive(false);
        ...
        //----------------------------------------------------------------------------
        else if (collision.gameObject.name == "currypowder(Clone)") //6TH INGREDIENT
        {
            //check if previous step completed first
            if (step5done == true)
            {
                ...
                Debug.Log(collision.gameObject.name); Debug.Log("THIS IS currypowder");
                collision.gameObject.SetActive(false);
                textwrong.SetActive(false);
        ...
        //----------------------------------------------------------------------------
        else if (collision.gameObject.name == "water(Clone)") //7TH INGREDIENT
        {
            //check if previous step completed first
            if (step6done == true)
            {
        ...
        //----------------------------------------------------------------------------
        else if (collision.gameObject.name == "Meat(Clone)") //9TH INGREDIENT
        {
            //check if previous step completed first
            if (step8done == true)
            {
                ...
                Debug.Log(collision.gameObject.name); Debug.Log("THIS IS meat");
                collision.gameObject.SetActive(false);
                textwrong.SetActive(false);
        ...
        //----------------------------------------------------------------------------
        else if (collision.gameObject.name == "Santan(Clone)") //10TH INGREDIENT--LAST
        {
            //check if previous step completed first
            if (step9done == true)
            {
