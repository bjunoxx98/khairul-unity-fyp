...
using UnityEngine;
//THIS IS FOR ALGO - RENDANG ONLY 1801-2145
public class gameflowalgo : MonoBehaviour
{
    ...
    public endplatformpot epscriptrendang;
    ...
    void Update()
    {
        ...
        {
            if (timeRemaining > 0 && epscriptrendang.stageComplete == true)
            {
            ...
            else if(timeRemaining > 0 && epscriptrendang.terminategame == true)
            {
    ...
    public void startGame()
    {
        ...
        timerIsRunning = true;
        timeRemaining = 60; // SET TIMER TO 1:00 BEFORE GAME STOP
    ...
    public void PostScores(int score, string email)
    {
        ...
        form.AddField("score10", score); //change scorex < x for php decide which column to update
