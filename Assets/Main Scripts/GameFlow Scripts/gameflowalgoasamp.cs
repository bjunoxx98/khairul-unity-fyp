...
using UnityEngine;
//THIS IS FOR ALGO - ASAMPEDAS ONLY 1801-2155
public class gameflowalgoasamp : MonoBehaviour
{
    ...
    public endplatformpotasamp epscriptasamp;
    ...
    void Update()
    {
        ...
        {
            if (timeRemaining > 0 && epscriptasamp.stageComplete == true)
            {
            ...
            else if (timeRemaining > 0 && epscriptasamp.terminategame == true)
            {
    ...
    public void startGame()
    {
        ...
        timerIsRunning = true;
        timeRemaining = 75; // SET TIMER TO 1:10 BEFORE GAME STOP
    ...
    public void PostScores(int score, string email)
    {
        ...
        form.AddField("score11", score);    //<----- changed to score11
