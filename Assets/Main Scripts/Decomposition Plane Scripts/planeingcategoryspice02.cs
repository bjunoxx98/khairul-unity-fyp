...
//EDITING FOR DECOMP - 02 - asamp
public class planeingcategoryspice02 : MonoBehaviour
{
    ...
    {
        //--------------------------------------------------------------------------1
        if (ChilliCounter >= 2)       //CHECK CHICKEN NUMBER
        {
            ChilliisThere = true;
        ...
        if (asamCounter >= 2)       //CHECK MEAT NUMBER
        {
            asamisThere = true;
        ...
        if (ChilliisThere == true && saltisThere == true && SugarisThere == true && kerisikisThere == true && asamisThere == true)
        {
