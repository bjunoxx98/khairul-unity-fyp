...
public class planeingcategoryspice03 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (curypowderCounter >= 2)       //CHECK MEAT NUMBER
        {
        ...
        if (spicesCounter >= 2)       //CHECK FISH NUMBER
        {
            spicesisThere = true;
        ...
        //--------------------------------------------------------------------------4
        if (daunkariCounter >= 2)       //CHECK CHICKEN NUMBER
        {
        ...
        if (ChilliisThere == true && curypowderisThere == true && spicesisThere == true && daunkariisThere == true &&
            saltisThere == true && SugarisThere == true && kerisikisThere == true && asamisThere == true)
        {
