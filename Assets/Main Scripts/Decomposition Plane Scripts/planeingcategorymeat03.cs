...
//EDITING FOR DECOMP - 03 - curry
public class planeingcategorymeat03 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (meatCounter >= 3)       //CHECK MEAT NUMBER
        {
            meatisThere = true;
        ...
        if (chickenisThere == true && meatisThere == true && fishisThere == true && eggisThere == true)
        {
