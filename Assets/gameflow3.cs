...
//EDITING FOR DECOMP-03-CURRY 2201 0800
public class gameflow3 : MonoBehaviour
{
    ...
    public planeingcategorymeat03 meat;
    public planeingcategoryvegie03 vegie;
    public planeingcategoryliquid03 liquid;
    public planeingcategoryspice03 spice;
    ...
    void Update()
    {
        ...
        if (meat.gameComplete == true && vegie.gameComplete == true && liquid.gameComplete == true && spice.gameComplete == true)
        {
            ...
            if (timeRemaining > 30)   //3 STAR  1:30
            {
                //DISPLAY 3 STARS
                endcanvas.SetActive(true);
            ...
            else if (timeRemaining > 20)  //2 STAR   1:40
            {
                //DISPLAY 2 STARS
                endcanvas.SetActive(true);
                completemessage.SetActive(true);
    ...
    public void startGame()
    {
        ...
        timerIsRunning = true;
        timeRemaining = 120; //LEVEL 1 SET TIMER TO 2:00 BEFORE GAME STOP
    ...
    public void PostScores(int score, string email)     // <WORKING 2201-2000
    {
        ...
        form.AddField("score3", score);    //<----- changed to score3
